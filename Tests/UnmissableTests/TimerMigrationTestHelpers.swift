...
class TimerMigrationTestHelpers: XCTestCase {
  ...
  static func createTestPreferencesManager() -> PreferencesManager {
    ...
    prefs.soundEnabled = false  // Disable sound in tests
  ...
  static func createTestEvent(
    ...
    return Event(
      ...
      primaryLink: URL(string: "https://test.example.com"),
      additionalLinks: []
    )
  }
...
extension TimerMigrationTestHelpers {
  ...
  enum SnoozeTimer {
    ...
    static func createSnoozeTestEvent(snoozeMinutes: Int = 5) -> Event {
