...
final class OverlayManagerIntegrationTests: XCTestCase {
  ...
  func testShowOverlayDoesNotCrash() async {
  ...
  func testSnoozeOverlayDoesNotCauseInfiniteLoop() async {
    let event = createTestEvent()
  ...
  func testHideOverlayCleanupsProperly() async {
    let event = createTestEvent()
  ...
  func testMultipleShowCallsDoNotAccumulate() async {
  ...
  func testSnoozeWithoutActiveEventDoesNotCrash() async {
