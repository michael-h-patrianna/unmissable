...
class EventFilteringTests: XCTestCase {
  ...
  func testCancelledEventFiltering() async throws {
  ...
  func testDeclinedEventFiltering() async throws {
  ...
  func testAcceptedEventNotFiltered() async throws {
  ...
  func testTentativeEventNotFiltered() async throws {
  ...
  func testEventWithoutCurrentUserNotFiltered() async throws {
  ...
  func testEventWithMissingStatusDefaultsToConfirmed() async throws {
  ...
  func testAttendeeSelfFieldParsing() async throws {
